...
export function Acknowledgements() {
    ...
    return (
        <div className="flex flex-col">
            ...
            <input id="acknowledgments-text" className="w-96 border-[1px] p-2 rounded-md mb-6" {...register('acknowledgements.text')} />
            {errors.acknowledgements?.text && <span>{errors.acknowledgements.text.message}</span>}
